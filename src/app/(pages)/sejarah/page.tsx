...
import TimelineSejarah from "@/components/timeline-sejarah"
...
// This page is rendered on the server. Interactive timeline is moved to a client component.
export default function SejarahDesa() {
  ...
  // timeline interactivity moved to client component TimelineSejarah
      ...
      <main className="container mx-auto px-4 pb-8 max-w-6xl">
        ...
        <section className="mb-12">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-blue-200">
            ...
            <CardContent>
              <TimelineSejarah villageLeaders={villageLeaders} periodColorMap={periodColorMap} />
            </CardContent>
          </Card>
        </section>
